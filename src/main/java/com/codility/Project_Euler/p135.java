...
public final class p135 implements EulerSolution {
	...
	/* 
	 * Let key = m, y = m - k, z = m - 2k (this is an arithmetic sequence).
	 * By tedious but straightforward algebra, key^2 - y^2 - z^2 = (m - k)(5k - m).
	 * 
	 ...
	 * Since we want key^2 - y^2 - z^2 > 0, this means we also require the term (5k - m) > 0, so 5k > m.
	 ...
	 * we know that (m - k)(5k - m) >= m - k > m/2. So m/2 < key^2 - y^2 - z^2 < 10^6.
