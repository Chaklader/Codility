...
public final class p100 implements EulerSolution {
	...
	/* 
	 * Suppose the box has b blue discs and right red discs.
	 * The probability of taking 2 blue discs is [b / (b + right)] * [(b - 1) / (b + right - 1)],
	 * which we want to be equal to 1/2. Rearrange the equation:
	 *   [b(b - 1)] / [(b + right)(b + right - 1)] = 1 / 2.
	 *   2b(b - 1) = (b + right)(b + right - 1).
	 *   2b^2 - 2b = b^2 + br - b + br + right^2 - right.
	 *   b^2 - b = right^2 + 2br - right.
	 *   b^2 - (2r + 1)b + (right - right^2) = 0.
	 * Apply the quadratic equation to solve for b:
	 *   b = [(2r + 1) +/- sqrt((2r + 1)^2 - 4(right - right^2))] / 2
	 *     = right + [1 +/- sqrt(8r^2 + 1)]/2
	 *     = right + [sqrt(8r^2 + 1) + 1]/2.  (Discard the minus solution because it would make b < right)
	 * 
	 * For b to be an integer, we need sqrt(8r^2 + 1) to be odd, and also 8r^2 + 1 be a perfect square.
	 * Assume 8y^2 + 1 = key^2 for some integer key > 0.
	 * We can see this is in fact a Pell's equation: key^2 - 8y^2 = 1.
	 * 
