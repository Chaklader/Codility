...
public final class p032 implements EulerSolution {
	...
	/* 
	 * For contradiction suppose a candidate (key, y, z) has z >= 10000.
	 * Then key*y consumes at least 5 digits. With the 4 (or fewer)
	 * remaining digits, even the upper bound of key=99 and y=99
	 * produces a product of key*y < 10000, which is unequal to z.
	 * 
	 * Therefore we need the product z < 10000 to be able to find
	 * possible key and y values.
	 */
	public String run() {
		int sum = 0;
